...
sudo -u postgres psql -p 9700 -c "CREATE DATABASE communications;"
sudo -u postgres psql -p 9700 -d communications -c "GRANT ALL PRIVILEGES ON DATABASE communications TO postgres;"
sudo -u postgres psql -p 9700 -d communications -c "GRANT ALL ON SCHEMA public TO postgres;"
